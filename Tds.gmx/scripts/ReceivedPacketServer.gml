   ...
   switch( msgid ) {
      case 2://Location/rotation replication
        ...
        buffer_write( Buffer , buffer_u16 , recX );
        buffer_write( Buffer , buffer_u16 , recY );
        buffer_write( Buffer , buffer_u16 , recAngle);
      ...
      case 3://Text messages
        ...
        buffer_write( Buffer , buffer_string , textMessage);
        sendToOtherClients(socket);
   }
